...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(() => ({
    python: [
      'print("Hello, World! 👋 I\'m Youness")',
      'print("Based in Germany 🇩🇪")',
      'print("From Software to AI: Software Engineer with 2+ years in Python , C++  and JavaScript, specializing in AI Software")'
    ],
    javascript: [
      'console.log("Hello, World! 👋 I\'m Youness");',
      'console.log("Based in Germany 🇩🇪");',
      'console.log("From Software to AI: Software Engineer with 2+ years in Python , C++  and JavaScript, specializing in AI Software");'
    ]
  }), []);
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">youness@portfolio:~$</span>
